    ...
    <div className="bg-slate-100 min-h-screen flex flex-col">
      <div className="flex flex-col md:flex-row items-center md:items-start mt-20">
        ...
        <div className="bg-white w-full md:w-1/2 p-4 md:pl-8 rounded-2xl mt-4 md:mt-4 md:mr-80">
          ...
          <button className="mt-6 bg-green-950 text-white py-2 px-4 rounded-md hover:bg-green-800">Add to Bag</button>
          <div className="mt-8">
            <h2 className="text-2xl font-bold">Product Details</h2>
            <p className="text-gray-600 mt-2">This boho style blue jeans coverall has strong summer vibes. Inspired by freedom and youth, this coverall was designed to bring you only good memories. Casual yet stylish, this sleeveless coverall will leave you looking effortlessly cool. Add bright socks, high platform shoes, and here you are, the coolest girl in town. Fabric & care.</p>
          </div>
